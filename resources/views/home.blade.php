                    ...
                    <div class="row">
                        <div class="col-md-4 d-flex">
                            <div class="card wizard-card flex-fill">
                                <div class="card-body">
                                    <p class="text-primary mt-0 mb-2">{{ trans('main.Users') }}</p>
                                    <h5>{{ App\Models\User::count(); }}</h5>
                                    <p>
                                        <a href="{{ route('user.index') }}">{{ trans('main.View Details') }}</a>
                                    </p>
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="card wizard-card flex-fill">
                                <div class="card-body">
                                    ...
                                    <p>
                                        <a href="{{ route('product.index') }}">{{ trans('main.View Details') }}</a>
                                    </p>
                                    <span class="dash-widget-icon bg-1">
                        ...
                        <div class="col-md-4 d-flex">
                            <div class="card wizard-card flex-fill">
                                <div class="card-body">
                                    <p class="text-primary mt-0 mb-2">{{ trans('main.Categorys') }}</p>
                                    <h5>{{ App\Models\Category::count(); }}</h5>
                                    <p>
                                        <a href="{{ route('category.index') }}">{{ trans('main.View Details') }}</a>
                                    </p>
                                    <span class="dash-widget-icon bg-1">
