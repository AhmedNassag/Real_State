        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-btn delete-action">
                    <form action="{{ route('country.deleteSelected') }}" method="POST" id="delete_multi_country_form">
                        @csrf
                        <!-- id -->
                        <div class="form-group">
                            <input class="text" type="hidden" id="delete_selected_id" name="delete_selected_id" value='' autocomplete="off">
                        </div>
