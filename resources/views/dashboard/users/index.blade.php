								...
								<div class="row filter-row">
									...
									<div class="col-sm-6 col-md-3">
										<div class="form-group">
											...
											<input id="email" type="email" class="form-control" name="email" value="{{ $email }}" autocomplete="off">
										</div>
									</div>
									<div class="col-sm-6 col-md-3">
										<div class="form-group">
											<label for="mobile">{{ trans('main.Mobile') }}</label>
											<input id="mobile" type="text" class="form-control" name="mobile" value="{{ $mobile }}" autocomplete="off">
										</div>
									</div>
									<div class="col-sm-6 col-md-3">
										<div class="form-group">
                                                        ...
                                                        <td class="text-center">
                                                            @if (!empty($item->getRoleNames()))
                                                                @foreach ($item->getRoleNames() as $v)
                                                                    <label for="roles_name" class="badge badge-primary">{{ $v }}</label>
                                                                @endforeach
                                                            @endif
                                                        </td>
                                                        <td class="text-center">
