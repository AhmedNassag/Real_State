                        ...
                        <div class="card-body">
                                ...
                                <div class="">
                                    <div class="row mg-b-20">
                                        ...
                                        <div class="parsley-input col-md-6" id="fnWrapper">
                                            ...
                                            <input id="name" type="text" name="name" class="form-control" value="{{ $item->name }}" required autocomplete="off">
                            ...
                            <div class="row mg-b-20">
                                ...
                                <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                    ...
                                    {!! Form::password('confirm-password', array('id' => 'confirm-password', 'class' => 'form-control','required')) !!}
                                </div>
                            </div>
                            ...
                            <div class="row row-sm mg-b-20">
                                ...
                                <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                    ...
                                    {!! Form::number('mobile', null, array('id' => 'mobile', 'class' => 'form-control','required')) !!}
                                </div>
