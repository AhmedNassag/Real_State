                        ...
                        <div class="card">
                            <div class="card-body pt-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control name" name="name" value="{{ old('name') }}" placeholder="{{ trans('main.Name') }}" autocomplete="off">
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="card flex-fill">
                                                ...
                                                <div class="card-footer">
                                                    <label class="form-group toggle-switch mb-0">
                                                        <input type="checkbox" class="toggle-switch-input" name="permission[]" value="{{ $value->id }}" autocomplete="off">
