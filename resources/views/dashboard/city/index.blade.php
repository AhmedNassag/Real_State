...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <!-- Search Filter -->
            <div class="card filter-card" id="filter_inputs" @if($name || $country_id || $from_date || $to_date) style="display:block" @endif>
            ...
            <div class="row">
                                ...
                                <table id="example1" class="table table-stripped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $item->country ? $item->country->name : '' }}</td>
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('city.show', $item->id) }}" role="button" class="btn btn-sm btn-info" title="{{ trans('main.Show') }}"><i class="far fa-eye"></i></a>
                                            </td>
                                        </tr>
                ...
                @include('dashboard.city.deleteSelectedModal')
            </div>
        </div>
    </div>
    <!-- /Page Wrapper -->
