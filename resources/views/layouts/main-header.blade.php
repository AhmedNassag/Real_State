...
<div class="header">
    ...
    <div class="header-left">
        <a href="{{ route('home') }}" class="logo">
            <img src="{{ asset('public/assets_admin/img/logo.jpg') }}" alt="Logo">
        </a>
        <a href="{{ route('home') }}" class="logo logo-small">
            <img src="{{ asset('public/assets_admin/img/logo-small.jpg') }}" alt="Logo" width="30" height="30">
        </a>
    ...
    <ul class="nav user-menu">
                ...
                <div class="dropdown-menu notifications">
                    <div class="topnav-dropdown-header">
                        ...
                        <a href="{{ route('markAllAsRead') }}"
                            class="clear-noti">{{ trans('main.Mark All Read') }}</a>
                    </div>
                                        ...
                                        <div class="media d-flex">
                                            ...
                                            <div class="media-body flex-grow-1">
                                                <p class="noti-details"><span
                                                        class="noti-title">{{ $notification->data['title'] }}
                                                        {{ $notification->data['user'] }}</span></p>
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
                    <img src="{{ asset('public/assets_admin/img/profiles/logo-01.jpg') }}" alt="">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="{{ route('logout') }}"
                    onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
                        data-feather="log-out" class="mr-1"></i> {{ trans('main.Logout') }}</a>
